...
class UIConstants {
  ...
  static const double gridNavigationBarHeight = 32.0;

  /// Navigation button icon size (regular)
  static const double gridNavButtonIconSize = 14.0;

  /// Navigation button icon size (primary)
  static const double gridNavButtonIconSizePrimary = 14.0;

  // === PADDING & SPACING ===

  /// Horizontal padding for navigation buttons
  static const double gridNavButtonPaddingHorizontal = 12.0;
