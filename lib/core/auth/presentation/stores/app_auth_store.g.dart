...
mixin _$AppAuthStore on _AppAuthStoreBase, Store {
  late final _$isAuthenticatedAtom = Atom(
    name: '_AppAuthStoreBase.isAuthenticated',
    context: context,
  );
  ...
  late final _$isLoadingAtom = Atom(
    name: '_AppAuthStoreBase.isLoading',
    context: context,
  );
  ...
  late final _$errorMessageAtom = Atom(
    name: '_AppAuthStoreBase.errorMessage',
    context: context,
  );
  ...
  late final _$signInAnonymouslyAsyncAction = AsyncAction(
    '_AppAuthStoreBase.signInAnonymously',
    context: context,
  );
