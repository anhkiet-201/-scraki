...
class QsvCompositionEngine implements VideoCompositionEngine {
  @override
  String buildCompositionFilter({
    ...
    // Stage 1: Intel VPP Scaling (Hardware)
    sb.write('[0:v]vpp_qsv=w=$zoomW:h=$zoomH,crop=1080:1920:(iw-1080)*$randX:(ih-1920)*$randY,hwdownload,format=nv12');
